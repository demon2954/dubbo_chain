...
public class DateUtils {
	...
	public static void main(String[] args) {
		...
		System.out.println(format(getStartOfMonth(date), FULL_READ_INDENT_PATTERN));
		System.out.println(format(getEndOfMonth(date), FULL_READ_INDENT_PATTERN));


		Date now = DateUtils.parse("2017-08", DateUtils.SHORT_SMALL_PATTERN);
		System.out.println(now.getTime());
		now = DateUtils.parse("2017-08-01", DateUtils.FULL_SMALL_PATTERN);
		System.out.println(now.getTime());
		now = DateUtils.parse("2017-08-01 00:00:00", DateUtils.FULL_BAR_PATTERN);
		System.out.println(now.getTime());
	}
